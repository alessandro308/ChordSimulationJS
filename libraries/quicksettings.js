...
(function () {
  ...
  */
   ...
   * @static
   */
		useExtStyleSheet: function useExtStyleSheet() {
			cssInjected = true;
		},
   ...
   * @static
   */
		create: function create(x, y, title, parent) {
   ...
   */
		...
		_init: function _init(x, y, title, parent) {
			if (!cssInjected) {
				injectCSS();
			}
			this._bindHandlers();
   ...
   */
		getValuesAsJSON: function getValuesAsJSON(asString) {
			var json = {};
		...
		// CREATION FUNCTIONS
		////////////////////////////////////////////////////////////////////////////////
		_createPanel: function _createPanel(x, y, parent) {
		...
		_createTitleBar: function _createTitleBar(text) {
		...
		_createElement: function _createElement(type, className, parent) {
		...
		_createLabel: function _createLabel(title, container) {
   ...
   * @returns {module:QuickSettings}
   */
		setSnapToGrid: function setSnapToGrid(snap) {
   ...
   * @returns {module:QuickSettings}
   */
		setGlobalChangeHandler: function setGlobalChangeHandler(handler) {
			this._globalChangeHandler = handler;
			return this;
		},

		_callGCH: function _callGCH() {
   ...
   * @returns {module:QuickSettings}
   */
		setCollapsible: function setCollapsible(collapsible) {
   ...
   */
		...
		_doubleClickTitle: function _doubleClickTitle() {
   ...
   * @returns {module:QuickSettings}
   */
		removeControl: function removeControl(title) {
   ...
   * @returns {module:QuickSettings}
   */
		enableControl: function enableControl(title) {
			if (this._controls[title]) {
   ...
   * @returns {module:QuickSettings}
   */
		disableControl: function disableControl(title) {
			if (this._controls[title]) {
   ...
   * @returns {module:QuickSettings}
   */
		hideControl: function hideControl(title) {
			if (this._controls[title]) {
   ...
   * @returns {module:QuickSettings}
   */
		showControl: function showControl(title) {
			if (this._controls[title]) {
   ...
   * @returns {module:QuickSettings}
   */
		overrideStyle: function overrideStyle(title, style, value) {
			if (this._controls[title]) {
   ...
   * @returns {module:QuickSettings}
   */
		hideAllTitles: function hideAllTitles() {
			for (var title in this._controls) {
				var label = this._controls[title].label;
				if (label) {
					label.style.display = "none";
   ...
   * @returns {module:QuickSettings}
   */
		showAllTitles: function showAllTitles() {
			for (var title in this._controls) {
				var label = this._controls[title].label;
				if (label) {
					label.style.display = "block";
   ...
   * @returns {module:QuickSettings}
   */
		parse: function parse(json, parent, scope) {
   ...
   * @returns {module:QuickSettings}
   */
		addRange: function addRange(title, min, max, value, step, callback) {
   ...
   * @returns {module:QuickSettings}
   */
		addNumber: function addNumber(title, min, max, value, step, callback) {
			return this._addNumber("number", title, min, max, value, step, callback);
		},

		_addNumber: function _addNumber(type, title, min, max, value, step, callback) {
   ...
   * @returns {module:QuickSettings}
   */
		bindRange: function bindRange(title, min, max, value, step, object) {
   ...
   * @returns {module:QuickSettings}
   */
		bindNumber: function bindNumber(title, min, max, value, step, object) {
   ...
   * @returns {Number}
   */
		getRangeValue: function getRangeValue(title) {
   ...
   * @returns {Number}
   */
		getNumberValue: function getNumberValue(title) {
   ...
   * @returns {module:QuickSettings}
   */
		setRangeValue: function setRangeValue(title, value) {
   ...
   * @returns {module:QuickSettings}
   */
		setNumberValue: function setNumberValue(title, value) {
			var control = this._controls[title];
   ...
   * @returns {module:QuickSettings}
   */
		setRangeParameters: function setRangeParameters(title, min, max, step) {
   ...
   * @returns {module:QuickSettings}
   */
		setNumberParameters: function setNumberParameters(title, min, max, step) {
			var control = this._controls[title];
   ...
   * @returns {module:QuickSettings}
   */
		addBoolean: function addBoolean(title, value, callback) {
			var container = this._createContainer();
   ...
   * @returns {module:QuickSettings}
   */
		bindBoolean: function bindBoolean(title, value, object) {
   ...
   * @returns {Boolean}
   */
		getBoolean: function getBoolean(title) {
   ...
   * @returns {module:QuickSettings}
   */
		setBoolean: function setBoolean(title, value) {
   ...
   * @returns {module:QuickSettings}
   */
		addButton: function addButton(title, callback) {
			var container = this._createContainer();
   ...
   * @returns {module:QuickSettings}
   */
		addColor: function addColor(title, color, callback) {
   ...
   * @returns {module:QuickSettings}
   */
		bindColor: function bindColor(title, color, object) {
   ...
   * @returns {String}
   */
		getColor: function getColor(title) {
   ...
   * @returns {module:QuickSettings}
   */
		setColor: function setColor(title, value) {
			var control = this._controls[title];
			control.control.value = value;
			control.label.innerHTML = "<b>" + title + ":</b> " + control.control.value;
			if (control.callback) {
   ...
   * @returns {module:QuickSettings}
   */
		addText: function addText(title, text, callback) {
			var container = this._createContainer();
   ...
   * @returns {module:QuickSettings}
   */
		bindText: function bindText(title, text, object) {
   ...
   * @returns {String}
   */
		getText: function getText(title) {
			return this._controls[title].control.value;
		},
   ...
   * @returns {module:QuickSettings}
   */
		setText: function setText(title, text) {
			var control = this._controls[title];
   ...
   * @returns {module:QuickSettings}
   */
		addPassword: function addPassword(title, text, callback) {
			var container = this._createContainer();
			var label = this._createLabel("<b>" + title + "</b>", container);
   ...
   * @returns {module:QuickSettings}
   */
		bindPassword: function bindPassword(title, text, object) {
   ...
   * @returns {module:QuickSettings}
   */
		addTextArea: function addTextArea(title, text, callback) {
			var container = this._createContainer();
			var label = this._createLabel("<b>" + title + "</b>", container);
   ...
   * @returns {module:QuickSettings}
   */
		setTextAreaRows: function setTextAreaRows(title, rows) {
   ...
   * @returns {module:QuickSettings}
   */
		bindTextArea: function bindTextArea(title, text, object) {
   ...
   * @returns {*}
   */
		addDate: function addDate(title, date, callback) {
			var dateStr;
   ...
   * @returns {module:QuickSettings}
   */
		setDate: function setDate(title, date) {
			var control = this._controls[title];
   ...
   * @returns {*}
   */
		bindDate: function bindDate(title, date, object) {
   ...
   * @returns {String}
   */
		getDate: function getDate(title) {
			var control = this._controls[title];
   ...
   * @returns {*}
   */
		addTime: function addTime(title, time, callback) {
			var timeStr;
   ...
   * @returns {module:QuickSettings}
   */
		setTime: function setTime(title, time) {
			var control = this._controls[title];
   ...
   * @returns {String}
   */
		getTime: function getTime(title) {
			var control = this._controls[title];
			return control.control.value;
		},
   ...
   * @returns {*}
   */
		bindTime: function bindTime(title, time, object) {
   ...
   */
		addInfo: function addInfo(title, info) {
   ...
   */
		getInfo: function getInfo(title) {
   ...
   */
		setInfo: function setInfo(title, info) {
   ...
   * @returns {module:QuickSettings}
   */
		addDropDown: function addDropDown(title, items, callback) {
			var container = this._createContainer();
   ...
   * @returns {module:QuickSettings}
   */
		bindDropDown: function bindDropDown(title, items, object) {
   ...
   * @returns {Object}
   */
		getDropDownValue: function getDropDownValue(title) {
			var control = this._controls[title],
   ...
   * @returns {module:QuickSettings}
   */
		setDropDownIndex: function setDropDownIndex(title, index) {
			var control = this._controls[title],
   ...
   * @returns {module:QuickSettings}
   */
		addImage: function addImage(title, imageURL) {
			var container = this._createContainer(),
   ...
   * @returns {module:QuickSettings}
   */
		setImageURL: function setImageURL(title, imageURL) {
   ...
   * @returns {module:QuickSettings}
   */
		addProgressBar: function addProgressBar(title, max, value, valueDisplay) {
			var container = this._createContainer(),
   ...
   * @returns {Number}
   */
		getProgress: function getProgress(title) {
			return this._controls[title].control.value;
		},
   ...
   * @returns {module:QuickSettings}
   */
		setProgress: function setProgress(title, value, max) {
			var control = this._controls[title];
			control.value = value;
			if (max) {
				control.max = max;
   ...
   * @returns {module:QuickSettings}
   */
		addFileChooser: function addFileChooser(title, labelStr, filter, callback) {
			var container = this._createContainer();
			var label = this._createLabel("<b>" + title + "</b>", container);
		...
		getFile: function getFile(title) {
   ...
   * @returns {module:QuickSettings}
   */
		addElement: function addElement(title, element) {
			var container = this._createContainer(),
			    label = this._createLabel("<b>" + title + "</b>", container);
   ...
   * @returns {module:QuickSettings}
   */
		addHTML: function addHTML(title, html) {
			var container = this._createContainer();
			var label = this._createLabel("<b>" + title + ":</b> ", container);
   ...
   * @returns {String}
   */
		getHTML: function getHTML(title) {
   ...
   * @returns {module:QuickSettings}
   */
		setHTML: function setHTML(title, html) {
